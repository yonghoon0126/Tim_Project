...
<form name="listRev" method="post">
	...
	<table class="table">
		<tr>
			<th>날짜</th><th>시간</th><th>가게</th><th>삭제하기</th>
		</tr>
	...
	<input class="btn1" type="button" onclick="delConRev()" value="삭제하기">
	<input class="btn1" type="button" onclick="goConMain()" value="메인으로 가기">
	</div>
</form>
