...
insert into owner values('zzanggu','열정국밥','123','123','01-542-8542','서울시 강남구 떡잎1동 587-2','gook1.jpg');
insert into owner values('mangu','돈코츠나베','123','123','01-852-4312','서울시 강남구 떡잎1동 96-2','na1.jpg');
insert into owner values('doraemong','이찌방라멘','123','123','01-754-8853','서울시 강남구 떡잎3동 11-2','ramen1.jpg');
insert into owner values('konan','VIPs','123','123','01-356-1256','서울시 강남구 떡잎2동 56-55','vips1.jpg');
insert into owner values('totoro','삼첩분식','123','123','01-968-6321','서울시 강남구 떡잎2동 56','boon1.png');
insert into owner values('bororo','다래성','123','123','01-366-8882','서울시 강남구 떡잎1동 965-2','china1.png');
insert into owner values('yoosung','스시야미','123','123','01-223-8892','서울시 강남구 떡잎3동 599-2','cho1.jpg');
insert into owner values('sumin','투고샐러드','123','123','01-366-1524','서울시 강남구 떡잎1동 866-5','salad1.jpg');
insert into owner values('joohi','아비꼬카레','123','123','01-874-3561','서울시 강남구 떡잎2동 432-3','ka1.jpg');
insert into owner values('yonghoon','카페하루','123','123','01-574-8722','서울시 강남구 떡잎1동 17-9','cafe1.jpg');
insert into owner values('juin','타코따코','123','123','01-572-3215','서울시 강남구 떡잎3동 97-39','taco1.jpg');
insert into owner values('cook','피자공주','123','123','01-122-2842','서울시 강남구 떡잎2동 113-2','pizza1.jpg');
insert into owner values('doremi','동네밥집','123','123','01-357-7824','서울시 강남구 떡잎3동 87-2','han1.jpg');


------------------------------------------------------------메뉴

insert into menu values('열정국밥','gook1.jpg','순대국밥','9000','맛있는 전통 순대로 만들었습니다');
insert into menu values('열정국밥','gook2.jpg','콩나물국밥','7000','계란을 풀어 드시면 맛있어요');
insert into menu values('열정국밥','gook3.jpg','돼지국밥','9000','살코기수육으로 이루어진 담백한 영양돼지국밥입니다');
insert into menu values('열정국밥','gook4.jpg','매콤국밥','8000','얼큰 다대기 제공합니다');
insert into menu values('열정국밥','gook5.jpg','편육','12000','쫄깃쫄깃한 편육');

insert into menu values('돈코츠나베','na1.jpg','스키야끼','20000','우리가게 대표 음식이에요');
insert into menu values('돈코츠나베','na2.jpg','밀푀유나베','17000','소고기+깻잎+버섯');
insert into menu values('돈코츠나베','na3.jpg','크림우동','12000','촉촉하고 고소한 크림우동');
insert into menu values('돈코츠나베','na4.jpg','카레우동','10000','카레와 돈까스를 같이 즐겨요');
insert into menu values('돈코츠나베','na5.jpg','김치돈까스나베','16000','국내산 김치와 생돈까스의 조합');

insert into menu values('이찌방라멘','ramen1.jpg','돈코츠라멘','9000','진한 돼지육수 베이스의 기본라멘');
insert into menu values('이찌방라멘','ramen2.jpg','매콤라멘','10000','매콤한 국물이 땡긴다면 매콤라멘');
insert into menu values('이찌방라멘','ramen3.jpg','차슈라멘','11000','부드러운 식감의 차슈');
insert into menu values('이찌방라멘','ramen4.jpg','왕교자','7000','바삭한 튀김옷을 입은 왕교자');

insert into menu values('VIPs','vips2.png','등심숙주볶음','16000','국내산 한우');
insert into menu values('VIPs','vips3.png','스테이크세트','30000','스테이크+야채제공');
insert into menu values('VIPs','vips4.jpg','바베큐세트','35000','직화구이 바베큐');
insert into menu values('VIPs','vips5.jpg','특선세트','50000','해산물모둠+스테이크');
insert into menu values('VIPs','vips6.jpg','디저트','13000','디저트+커피제공');

insert into menu values('삼첩분식','boon1.png','떡볶이','5000','매콤달달 떡볶이');
insert into menu values('삼첩분식','boon2.png','김밥','4000','야채많이 김밥');
insert into menu values('삼첩분식','boon3.png','순대','3000','직접만든 순대');
insert into menu values('삼첩분식','boon4.jpg','어묵','1000','국물이 시원해요');
insert into menu values('삼첩분식','boon5.jpg','튀김','500','바삭바삭 튀김');

insert into menu values('다래성','china1.png','짜장면','5000','우리동네 베스트 짜장면');
insert into menu values('다래성','china2.png','짬뽕','8000','해산물 모둠 짬뽕');
insert into menu values('다래성','china3.png','만두','3000','튀김옷이 맛있어요');
insert into menu values('다래성','china4.jpg','탕수육','20000','탕수육시키면 만두 서비스');
insert into menu values('다래성','china5.jpg','동파육','15000','일단 먹어봐요');
insert into menu values('다래성','china6.jpg','마파두부','8000','간단한 점심메뉴로 추천');
insert into menu values('다래성','china7.png','깐풍기','30000','탕수육이 질렸다면 깐풍기~~');

insert into menu values('스시야미','cho1.jpg','초밥모둠','15000','모둠초밥이에요');
insert into menu values('스시야미','cho2.jpg','오꼬노미야끼','8000','소스많이 뿌려드려요');
insert into menu values('스시야미','cho3.jpg','타꼬야끼','3000','맛있는 타꼬야끼');
insert into menu values('스시야미','cho4.jpg','가라아게','5000','가라아게');

insert into menu values('투고샐러드','salad1.jpg','닭가슴살샐러드','10000','닭가슴살+옥수수+방울토마토');
insert into menu values('투고샐러드','salad2.jpg','단호박샐러드','8000','단호박+채소+수제소스');
insert into menu values('투고샐러드','salad3.jpg','소고기샐러드','12000','소고기+방울토마토+채소');
insert into menu values('투고샐러드','salad4.jpg','버섯샐러드','7000','버섯+소고기+채소');
insert into menu values('투고샐러드','salad5.jpg','연어샐러드','11000','연어+채소+옥수수');
insert into menu values('투고샐러드','salad6.jpg','자몽쥬스','5000','유기농 자몽으로 갈아만든 자몽쥬스');
insert into menu values('투고샐러드','salad7.jpg','키위쥬스','5000','유기농 키위로 갈아만든 키위쥬스');

insert into menu values('아비꼬카레','ka1.jpg','두가지맛카레','12000','두가지맛 카레입니다');
insert into menu values('아비꼬카레','ka2.jpg','오리지널카레','10000','우리가게 대표메뉴');
insert into menu values('아비꼬카레','ka3.png','오믈렛카레','15000','보들보들 오믈렛');
insert into menu values('아비꼬카레','ka4.png','돈까스카레','11000','국내산 돼지고기');

insert into menu values('카페하루','cafe2.jpg','아메리카노','5000','에스프레소 2샷 제공');
insert into menu values('카페하루','cafe3.jpg','쿠키앤크림','6000','벨기에산 초콜릿쿠키');
insert into menu values('카페하루','cafe4.jpg','자바칩','8000','촉촉한 초코칩');
insert into menu values('카페하루','cafe5.jpg','카페모카','7000','커피와 초코의 만남');
insert into menu values('카페하루','cafe6.jpg','와플','4000','와플+생크림 소스');

insert into menu values('타코따코','taco1.jpg','타코세트','25000','쉬림프타코+나쵸+음료');
insert into menu values('타코따코','taco2.jpg','가족세트','54000','비프타코+나쵸+카레우동+음료');

insert into menu values('피자공주','pizza1.jpg','피자세트','13000','에피타이저부터 메인,디저트의 3COURSE를 한입에');
insert into menu values('피자공주','pizza2.jpg','마르게리따피자','10000','이탈리안 정통 피자');
insert into menu values('피자공주','pizza3.jpg','감자튀김','5000','케이준 감자튀김');
insert into menu values('피자공주','pizza4.jpg','수제햄버거','10000','국내산 소고기로 만든 수제패티와 특제소스의 만남');

insert into menu values('동네밥집','han2.jpg','김치찌개','7000','이천 쌀+묵은지+돼지막고기+집반찬2종');
insert into menu values('동네밥집','han3.jpg','된장찌개','7000','이천 쌀+시골된장+조미김+집반찬2');
insert into menu values('동네밥집','han4.jpg','부대찌개','7000','각종 소세지모둠이 들어간 매콤부대찌개');
insert into menu values('동네밥집','han5.jpg','제육볶음','6000','국내산 돼지고기');
