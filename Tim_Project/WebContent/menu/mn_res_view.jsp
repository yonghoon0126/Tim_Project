...
.tg .tg-c3ow{border-color:inherit;text-align:center;vertical-align:center;font-size: medium;box-shadow:inset 0 0 8px #deb13a; background-color:#FFFFcc;}
...
<hr>
	<div class="res">
		...
		<table class="tg1">
		<tr>
		<td class="name" >${mn_name}</td>
		<tr>
	<td><img src="upload/${ow_img.ow_img}" class="img2"></td>
	</table>
	</div>
	<div class="a">
     <div class="bo"> 
