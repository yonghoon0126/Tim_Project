...
.tg1  {border-collapse:none;border-spacing:0;
...
.tg .tg-c3ow{border-color:inherit;text-align:center;vertical-align:center;font-size: medium;
box-shadow:inset 0 0 8px #deb13a; background-color:#FFFFcc;}
      ...
      <table class="tg1">
		...
		<div class="a">
			...
			<tr>
				...
				<th class="tg-c3ow" width="130px">가격</th>
				<th class="tg-c3ow" width="336px">설명</th>
				<th class="tg-c3ow" width="128px">삭제</th>
			</tr>
			</table>
			<div class="scroll" >
			<table class="tg">
			<c:forEach items="${menu}" var="menu">
				<tr>
					<td class="tg-0pky" width="230px"><img src="upload/${menu.mn_img}" class="img"></td>
